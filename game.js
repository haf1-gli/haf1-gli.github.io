// game.js - Main game loop with multiplayer synchronization
...
class GameState {
    constructor() {
        ...
        // Camera & controls locked during cutscene
...
function init() {
    ...
    // Set THREE reference for cutscene
        ...
        (gltf) => {
            ...
            for (let i = 0; i < count; i++) {
                ...
                warehouse.position.set(
                    THREE.MathUtils.randFloat(-225, 225),
                    0.8,
                    THREE.MathUtils.randFloat(-225, 225)
                );
